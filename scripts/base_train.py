...
parser.add_argument("--ve-mode", type=str, default="per_layer", choices=["per_layer", "v1_reuse"], help="value embedding strategy: per_layer (independent VE tables) or v1_reuse (reuse layer 0's V)")
